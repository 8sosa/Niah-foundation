    ...
    <>
        ...
        <Container className='origins'>
          ...
          <Accordion defaultActiveKey="0" className='accordion'>
            <Accordion.Item eventKey="0" className='aboutHeader' data-aos="fade-up">
            ...
            <Accordion.Item eventKey="1" className='aboutHeader' data-aos="fade-up">
            ...
            <Accordion.Item eventKey="2" className='aboutHeader' data-aos="fade-up">
        ...
        <Container className='founder' >
            <h1 className='founderHeader subHeader raleway' data-aos="fade-up">THE <span className='founderHeaderBold'>FOUNDER</span></h1>
            <img src={Founder} alt='the founder - Chenaniah Bamishile' className='founderPic' data-aos="zoom-in"/>
        ...
        <Container className='origins'>
          ...
          <h2 className='eventHeader subHeader raleway' id="eventHeader" data-aos="fade-up">ACHIEVEMENTS</h2>
          <ul data-aos="fade-up">
