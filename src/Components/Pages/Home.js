  ...
  return (
    <>
        ...
        <section className='mosaicBg mt-5 mb-5'>
          ...
          <p className='OFDesc mt-4' data-aos="fade-up">“Empowering communities through compassion and action. Our mission is to drive positive change by fostering education, supporting mental health, and cultivating a spirit of unity. Together, we strive to create a brighter future for all, one act of kindness at a time." - Chat GPT</p>
          <Row className='w100'>
            <Col className='d-flex flex-column justify-content-space-between'>
              <div className='boxDiv'>
                <h2 className='peachHeader1'>Mission</h2>
                <p className='OFDesc' data-aos="fade-up">To bring mental health awareness into every African home and as a result promote the inclusion of special needs individuals into systems in the continent.</p>
              </div>
              <div className='boxDiv m-0'>
                <h2 className='peachHeader1'>VISION</h2>
                <p className='OFDesc' data-aos="fade-up">To be the foremost voice and movement on mental health in Africa.</p>
              </div>
            </Col>
          ...
          <div className='boxDiv1'>
            ...
            <p className='OFDesc' data-aos="fade-up">Empowering communities through compassion and action. Our mission is to drive positive change by fostering education, supporting mental health, and cultivating a spirit of unity.</p>
            <p className='OFDesc' data-aos="fade-up">Empowering communities through compassion and action. Our mission is to drive positive change by fostering education, supporting mental health, and cultivating a spirit of unity.</p>
          </div>
        ...
        <section className='mosaicBg mt-4 pb-5 d-flex flex-column'>
          ...
          <Row className='mb-3 w100 remgap2'>
            ...
            <Col className='eventPic' data-aos="fade-left"></Col>
          </Row>
        ...
        <section className='greenBg1 pt-5 pb-5'>
          <h1 className='eventHeader1 mb-4 mt-2'>FUTURE EVENTS</h1>
            <Row className='mb-3 w100 remgap2'>
              ...
              <Col className='eventPic' data-aos="fade-right"></Col>
            </Row>
            <Row className='w100 remgap2'>
              <Col data-aos="fade-left">
                <h2 className='eventHeaderTxt'>2024 BOOK DONATION DRIVE</h2>
            ...
            <Row className='w100 remgap2'>
              <Col className='d-flex flex-column align-items-center' data-aos="fade-up">
        ...
        <section className='mosaicBg1 mt-4 pb-5 d-flex flex-column align-items-center' data-aos="fade-up">
          ...
          <div className='subscribeCard' data-aos="fade-up">
